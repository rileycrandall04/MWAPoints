...
# ---------------- Sheets helpers ----------------
    ...
    ws_entries = get_or_create("Entries")
    ws_daily = get_or_create("Daily Totals")
    ws_msum = get_or_create("Monthly Summary")
    ws_month_sheets = get_or_create("Monthly Sheets")

    return sh, ws_entries, ws_daily, ws_msum, ws_month_sheets
